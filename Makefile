...
CFLAGS += $(CDEFS) $(CINCS)
CFLAGS += -O$(OPT)
CFLAGS += -funsigned-char -funsigned-bitfields -fpack-struct -fshort-enums -fno-inline-small-functions -ffreestanding
...
LDFLAGS = -Wl,-Map=$(OBJDIR)/$(TARGET).map,--cref,--relax
LDFLAGS += $(EXTMEMOPTS)
...
AVRDUDE_FLAGS = -p t2313 -c $(AVRDUDE_PROGRAMMER)
